# Generated migration for financing app
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logo",
                    models.ImageField(
                        blank=True, null=True, upload_to="financing/partners/"
                    ),
                ),
                (
                    "min_loan_amount",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=500, help_text="Minimum credit score required (0-1000)"
                    ),
                ),
                (
                    "min_platform_tenure_days",
                    models.PositiveIntegerField(
                        default=90, help_text="Minimum days on platform"
                    ),
                ),
                (
                    "min_monthly_revenue",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_score",
                    models.PositiveSmallIntegerField(
                        default=0, help_text="Based on payment processing history"
                    ),
                ),
                (
                    "order_score",
                    models.PositiveSmallIntegerField(
                        default=0, help_text="Based on order volume and consistency"
                    ),
                ),
                (
                    "tenure_score",
                    models.PositiveSmallIntegerField(
                        default=0, help_text="Based on time on platform"
                    ),
                ),
                (
                    "activity_score",
                    models.PositiveSmallIntegerField(
                        default=0, help_text="Based on platform engagement"
                    ),
                ),
                (
                    "avg_monthly_revenue",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="financing_l_restaur_8d7c3f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loanapplication",
            index=models.Index(
                ...
                name="financing_l_partner_bae9f4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loanapplication",
            index=models.Index(
                ...
                name="financing_l_applica_c87f0e_idx",
            ),
        ),
        # Loan
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["restaurant", "status"],
                name="financing_l_restaur_22a3b1_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loan",
            index=models.Index(
                fields=["partner", "status"],
                name="financing_l_partner_f3c5a2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loan",
            index=models.Index(
                fields=["loan_number"],
                name="financing_l_loan_nu_d8e7c4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loan",
            index=models.Index(
                ...
                name="financing_l_next_pa_a9b2c3_idx",
            ),
        ),
        # LoanRepayment
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="financing_l_loan_id_b5c7d9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loanrepayment",
            index=models.Index(
                fields=["status"],
                name="financing_l_status_e2f4a6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="loanrepayment",
            index=models.Index(
                ...
                name="financing_l_payment_c1d3e5_idx",
            ),
        ),
        # FinancingSettings
        migrations.CreateModel(
