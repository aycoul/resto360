    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.CharField(choices=[('minimalist', 'Minimalist'), ('elegant', 'Elegant'), ('modern', 'Modern'), ('casual', 'Casual'), ('fine_dining', 'Fine Dining'), ('vibrant', 'Vibrant')], default='minimalist', max_length=20)),
                ...
                ('heading_font', models.CharField(choices=[('inter', 'Inter'), ('playfair', 'Playfair Display'), ('roboto', 'Roboto'), ('lato', 'Lato'), ('montserrat', 'Montserrat'), ('merriweather', 'Merriweather'), ('open_sans', 'Open Sans'), ('poppins', 'Poppins')], default='inter', max_length=20)),
                ('body_font', models.CharField(choices=[('inter', 'Inter'), ('playfair', 'Playfair Display'), ('roboto', 'Roboto'), ('lato', 'Lato'), ('montserrat', 'Montserrat'), ('merriweather', 'Merriweather'), ('open_sans', 'Open Sans'), ('poppins', 'Poppins')], default='inter', max_length=20)),
                ...
                ('logo_position', models.CharField(choices=[('left', 'Left'), ('center', 'Center'), ('right', 'Right')], default='center', max_length=10)),
