    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points_per_currency', models.DecimalField(decimal_places=2, default=1, help_text='Points earned per unit of currency spent', max_digits=5)),
                ('currency_unit', models.PositiveIntegerField(default=1000, help_text='Currency amount that earns points_per_currency points (e.g., 1000 XOF)')),
                ...
                ('points_value_currency', models.DecimalField(decimal_places=2, default=10, help_text='Currency value of each point when redeeming', max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points_multiplier', models.DecimalField(decimal_places=2, default=1.0, help_text='Multiplier for points earned (e.g., 1.5 for 50% bonus)', max_digits=3)),
                ('discount_percentage', models.PositiveIntegerField(default=0, help_text='Automatic discount percentage for this tier', validators=[django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='authentication.business')),
                ('menu_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='loyalty_rewards', to='menu.product')),
        ...
        migrations.AddIndex(
            model_name='customer',
            index=models.Index(fields=['business', 'email'], name='crm_custome_busines_a6b721_idx'),
        ),
        migrations.AddIndex(
            model_name='customer',
        ...
        migrations.AddIndex(
            model_name='customer',
            index=models.Index(fields=['business', 'loyalty_points'], name='crm_custome_busines_ae5640_idx'),
        ),
        migrations.AddIndex(
            model_name='customer',
            index=models.Index(fields=['referral_code'], name='crm_custome_referra_a7ff2e_idx'),
        ),
        migrations.AddIndex(
            model_name='pointstransaction',
            index=models.Index(fields=['customer', '-created_at'], name='crm_pointst_custome_e95e5e_idx'),
        ),
    ]
